...
class Hotel:
    ...
    comment_score: Optional[str]
    comment_description: Optional[str]
    commenter_number: Optional[str]
    collected_number: Optional[str]
    price_tags: Optional[str]
...
def parse_hotel(file_path:str =None, json_content: Dict = None) -> Tuple[List[Dict[str, Any]], List[Dict[str, Any]]]:
    """
